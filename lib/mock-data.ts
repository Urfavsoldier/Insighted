...
export const primaryStudent: Student = {
  ...
  className: "10A",
  avatar: "АС",
  bio: "Участвует в инженерном кружке, любит биологию и проектную работу. Готовится к школьной олимпиаде и хочет усилить математическую базу.",
  interests: ["Инженерный кружок", "Биология", "Дебаты", "Исследование интерфейсов"],
  attendance: 96.8,
  averageScore: 4.63,
  ...
  achievements: [
    {
      id: "a1",
      title: "2 место на школьном хакатоне",
      category: "Проект",
      date: "24 марта",
      level: "Школьный",
...
export const schoolEvents: SchoolEvent[] = [
  { id: "e1", title: "Открытая лаборатория: AI и робототехника", date: "31 марта", time: "15:30", audience: "8-11 классы", location: "Инженерная лаборатория", description: "Демонстрация ученических проектов и мини-воркшоп от наставников." },
